...
fulldata_2002_scores$MOM_AGE[is.na(fulldata_2002_scores$MOM_AGE)]<-median(fulldata_2002_scores$MOM_AGE[!is.na(fulldata_2002_scores$MOM_AGE)])
fulldata_2002_scores$DAD_AGE[is.na(fulldata_2002_scores$DAD_AGE)]<-median(fulldata_2002_scores$DAD_AGE[!is.na(fulldata_2002_scores$DAD_AGE)])
fulldata_2002_scores$MOM_SCH[is.na(fulldata_2002_scores$MOM_SCH)]<-median(fulldata_2002_scores$MOM_SCH[!is.na(fulldata_2002_scores$MOM_SCH)])
fulldata_2002_scores$DAD_SCH[is.na(fulldata_2002_scores$DAD_SCH)]<-median(fulldata_2002_scores$DAD_SCH[!is.na(fulldata_2002_scores$DAD_SCH)])
#fulldata_2002_scores$MOM_MW[is.na(fulldata_2002_scores$MOM_MW)]<-median(fulldata_2002_scores$MOM_AGE[!is.na(fulldata_2002_scores$MOM_AGE)])
#fulldata_2002_scores$DAD_MW[is.na(fulldata_2002_scores$DAD_MW)]<-median(fulldata_2002_scores$MOM_AGE[!is.na(fulldata_2002_scores$MOM_AGE)])
...
write.csv(mydata,paste0(my_path,"/ABBKK_2002/data/ABK_prepared_data_median.csv"))
